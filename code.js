      ...
      if (this.readyState == 4 && this.status == 200) {
        ...
        for (let i = 0; i < jsonObject.results.length; i++) {
          ...
          div.innerHTML =
            ...
            j + "' aria-expanded='false' aria-controls='collapse" + j + "'>" +
            "<span id = listFname" + i + ">" + jsonObject.results[i].FirstName + "</span> " + "<p> &nbsp</p>" +
            ...
            "<span id = listPhone" + i + ">" + jsonObject.results[i].Phone + "</span> " + " " +
            "<span id = listEmail" + i + ">" + jsonObject.results[i].Email + "</span> " +
            "&nbsp&nbsp&nbsp<button type='button' class='editbutton' onclick='editContact(" + 
            jsonObject.results[i].ID + "," + i +
            ");'> Edit </button>" +
...
function editContact(contactID , placeOnPage) {
    ...
    "<div class='row'>" +
      ...
      "</div>" +
      "<div class='col-sm-2'>" +
        "<button type='button' id='saveButton' class='buttons' onclick='saveEdit(" + contactID + ");'> Save</button>" +
      "</div>" +
    "</div>" +
    "<br />";
